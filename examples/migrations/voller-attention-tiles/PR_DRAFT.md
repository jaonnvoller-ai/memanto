...
Executed locally: official CLI preview, native mapper/export-format round trip, 11 new adapter tests, and 20 upstream OKF/migration tests. All 77 tiles in the private source snapshot were restored exactly; the included public-source sample contains 66. These are local format tests, not a completed backend migration or semantic recall result.
